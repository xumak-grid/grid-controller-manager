...
var databasesResource = schema.GroupVersionResource{Group: "databases.xumak.io", Version: "v1alpha1", Resource: "databases"}

var databasesKind = schema.GroupVersionKind{Group: "databases.xumak.io", Version: "v1alpha1", Kind: "Database"}
...
func (c *FakeDatabases) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Database, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(databasesResource, c.ns, name, data, subresources...), &v1alpha1.Database{})
